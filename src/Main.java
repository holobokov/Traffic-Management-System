...
public class Main {
    public static void main(String[] args) {
        ...
        Intersection intersection = new Intersection("Marszałkowska x Warszawska", 93.22, 224.1, directions, trfc, 3);
        Intersection intersection2 = new Intersection("Mikołowska x Karola Miarki", 53.22, 224.1, directions, trfc, 3);
        Intersection intersection3 = new Intersection("Mickiewicza x 3 maja", 97.22, 224.1, directions, trfc, 3);
...
//        Intersection.printIntersections();
        ...
        intersection.addVehicle(car, Direction.west);
